vim.api.nvim_create_autocmd('LspAttach', {
  ...
  callback = function(ev)
    ...
    -- vim.keymap.set('n', ']d', vim.diagnostic.goto_next, { buffer = opts.buffer, desc = "LSP goto_next diag" })
    -- vim.keymap.set('n', '[d', vim.diagnostic.goto_prev, { buffer = opts.buffer, desc = "LSP goto_prev diag" })
  end,
})
